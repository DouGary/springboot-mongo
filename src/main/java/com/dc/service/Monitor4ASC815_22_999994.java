...
@Component
public class Monitor4ASC815_22_999994 {
	@Autowired
	...
	Logger logger = LogManager.getLogger(Monitor4ASC815_22_999994.class);
	...
	public List<StockCode> getFinal(String endDateStr) throws Exception
	{
		...
		String startDate100DaysBeforeStr = helper.getStartDateStr15daysBefore(endDateStr,-10); // 要当天
...
//		scpoolRepository.save(scpool);
		...
		// 发email
		helper.sendEmail(allScpoolStatus.toString(),999994,endDateStr);
