...
@Component
public class Monitor4ASC815_22_8848 {
	@Autowired
	...
	Logger logger = LogManager.getLogger(Monitor4ASC815_22_8848.class);
...
//			    	historytradeInfo historytradeInfo = resultList2Days.get(0);
//					scpool scpool = new scpool(result.getNAME(),result.getSYMBOL(), "8848",endDateStr,historytradeInfo.getTrade_date(),historytradeInfo.getOpen());
			        Scpool scpool = new Scpool(result.getNAME(),result.getSYMBOL(), "8848",endDateStr,"",0.0);
