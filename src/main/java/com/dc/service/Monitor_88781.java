...
public class Monitor_88781 {
	...
	Logger logger = LogManager.getLogger(Monitor_88781.class);
...
//			}
//				
			if(stockbasics.getSYMBOL().equals("002516")){
				System.out.println("002516");
			}
...
//						double amount = historytradeInfo.getAmount()/10;
//						if(amount<30000){
//							PERCENTASC = false;
//							break;
//						}
...
//							previousDaysMa120 = historytradeInfo.getMa120();
					...
					if(days4His==0){
						...
						if(
//								historytradeInfo.getClose()>historytradeInfo.getMa5() &&
...
//			    	historytradeInfo historytradeInfo = resultList2Days.get(0);
//					scpool scpool = new scpool(result.getNAME(),result.getSYMBOL(), "88781",endDateStr,historytradeInfo.getTrade_date(),historytradeInfo.getOpen());
