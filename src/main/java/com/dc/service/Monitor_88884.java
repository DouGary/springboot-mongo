...
public class Monitor_88884 {
	...
	Logger logger = LogManager.getLogger(Monitor_88884.class);
...
//			}
//				
			if(stockjjcgph.getSYMBOL().equals("600882")){
//				System.out.println("600882");
			}
...
//					scpool scpool = new scpool(result.getNAME(),result.getSYMBOL(), "88884",endDateStr,historytradeInfo.getTrade_date(),historytradeInfo.getOpen());
					Scpool scpool = new Scpool(result.getNAME(),result.getSYMBOL(), "88884",endDateStr,"",0.0);
