...
public class Monitor4ASC815_22_8888464 {
	...
	Logger logger = LogManager.getLogger(Monitor4ASC815_22_8888464.class);
...
////					System.out.println(daysHighest);
//					if(daysHighest<50){
//						continue;
//					}
...
//				historytradeInfo historytradeInfoHighestDayBefore1Day =  helper.computeHighestHighPriceBefore1Day4kdj4Obj(resultList2Days,60);
//
//				if(historytradeInfoHighestDayBefore1Day!=null&& historytradeInfoHighestDayBefore1Day.getTrade_date()!=null) {
//
//					String trade_date = historytradeInfoHighestDayBefore1Day.getTrade_date();
//					DateFormat df = new SimpleDateFormat("yyyyMMdd");
//
//					Date date = df.parse(trade_date);
//					Date dateDangDay = df.parse(endDateStr);
...
//				if(percentLow > 25){
				...
				for(HistorytradeInfo historytradeInfo : resultList2Days ){
					...
					//  成交额小于2亿，不要
//					if(days4His==0) {
//						if (historytradeInfo.getAmount() < 200000) {
//							PERCENTASC = false;
//							break;
//						}
//					}
...
//					}
					...
					if(days4His==0){
						...
						// 保证 ma60 ma120 ma250，其中有两个是开始递增的
//						if(days4His==1){
//							if(previousDaysMa60 >= historytradeInfo.getMa60() ){
//								countPingHing++;
//							}
//							if(previousDaysMa120 >= historytradeInfo.getMa120()){
//								countPingHing++;
//							}
//							if(previousDaysMa240 >= historytradeInfo.getMa240() ){
//								countPingHing++;
...
//						}
						...
						if(historytradeInfo.getPct_chg()>3.5 || historytradeInfo.getPct_chg()< -3.5 ){
							PERCENTASC = false;
							break;
						}
...
////								|| stkdj.getVol() < (stkdj.getV_ma5()*1.5
//
//
//
//
