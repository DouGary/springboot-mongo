...
@Component
public class Monitor4ASC815_22_888884 {
	@Autowired
	...
	Logger logger = LogManager.getLogger(Monitor4ASC815_22_888884.class);
...
//			}
//				
			if(stockjjcgph.getSYMBOL().equals("603986")){
				System.out.println("603986");
			}
