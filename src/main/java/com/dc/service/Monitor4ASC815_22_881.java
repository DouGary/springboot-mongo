...
public class Monitor4ASC815_22_881 {
	...
	Logger logger = LogManager.getLogger(Monitor4ASC815_22_881.class);
...
//			}
//				
			if(stockbasics.getSYMBOL().equals("601888")){
				System.out.println("002385");
			}
...
//								&& historytradeInfo.getMa5()>=historytradeInfo.getMa240()
//								&& historytradeInfo.getMa10()>=historytradeInfo.getMa240()
//								&& historytradeInfo.getMa20()>=historytradeInfo.getMa240()
//								&& historytradeInfo.getMa30()>=historytradeInfo.getMa240()
//								&& historytradeInfo.getMa60()>=historytradeInfo.getMa240()
								&& historytradeInfo.getPct_chg()>3.8

//								&& historytradeInfo.getMa120()>=historytradeInfo.getMa240()
						){
							sore += 10000;
						}else{
							PERCENTASC = false;
...
//								|| stkdj.getVol() < (stkdj.getV_ma5()*1.2)
...
//					scpool scpool = new scpool(result.getNAME(),result.getSYMBOL(), "881",endDateStr,historytradeInfo.getTrade_date(),historytradeInfo.getOpen());
		         	Scpool scpool = new Scpool(result.getNAME(),result.getSYMBOL(), "881",endDateStr,"",0.0);
